...
public interface IPdfService
{
    ...
    Task<byte[]> GenerateServicebelegAsync(int serviceleistungId);
    ...
    Task<byte[]> GenerateKautionsrueckgabebelegAsync(int rentalId);
    Task<byte[]> GenerateAnzahlungsbelegAsync(int reservationId);
