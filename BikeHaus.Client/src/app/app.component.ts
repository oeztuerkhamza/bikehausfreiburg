      ...
      >
        ...
        <nav role="navigation" aria-labelledby="menu-label">
          ...
          >
            ...
            <span class="nav-label">Serviceleistungen</span>
          </a>
          <a
            routerLink="/returns"
            routerLinkActive="active"
          ...
          <a
            routerLink="/rental-availability"
            routerLinkActive="active"
            (click)="closeSidebar()"
          >
            <span class="nav-icon">
            ...
            <span class="nav-label">{{ t.rentalAvailability }}</span>
          </a>
          <a
          ...
          >
            ...
            <span class="nav-label">{{ t.rentalStatistics }}</span>
          </a>
          <a
          ...
          >
            ...
            <span class="nav-label">Belege</span>
          </a>
          <a
            routerLink="/labels"
            routerLinkActive="active"
          ...
          >
            ...
            <span class="nav-label">Kleinanzeigen Chat</span>
          </a>
          <a
            routerLink="/archive"
            routerLinkActive="active"
          ...
          >
            <span class="nav-icon">
              ...
              >
                <path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z" />
                <polyline points="22,6 12,13 2,6" />
                <path d="M18 2.5a2.5 2.5 0 0 1 2 4" />
              </svg>
            </span>
            <span class="nav-label">KI E-Mail Assistent</span>
          </a>
          <a
            routerLink="/settings"
            routerLinkActive="active"
