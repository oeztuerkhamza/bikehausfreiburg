...
@Component({
      ...
      <form (ngSubmit)="submit()" #f="ngForm">
        <div class="form-sections">
          ...
          <div class="form-card">
            ...
            <div class="quick-add-form" *ngIf="isQuickAddMode">
              ...
              <div class="form-grid">
                <div class="field">
                  ...
                  <input [(ngModel)]="bikeEdit.rahmennummer" name="bikeRahmen" style="text-transform: uppercase" required />
                </div>
                <div class="field">
                  <label>Marke *</label>
                ...
                <div class="field">
                  ...
                  <input [(ngModel)]="bikeEdit.reifengroesse" name="bikeReifen" />
                </div>
                <div class="field">
                  <label>Fahrradtyp</label>
                  <input [(ngModel)]="bikeEdit.fahrradtyp" name="bikeFahrradtyp" />
                </div>
              </div>
            </div>
            ...
            <div class="bike-edit-form" *ngIf="selectedBike && !isQuickAddMode">
              ...
              <div class="form-grid">
                <div class="field">
                  <label>Rahmennummer</label>
                  <input [(ngModel)]="bikeEdit.rahmennummer" name="bikeRahmen" style="text-transform: uppercase" />
                </div>
                <div class="field">
                  <label>Marke *</label>
                  <input [(ngModel)]="bikeEdit.marke" name="bikeMarke" required />
          ...
          <div class="form-card">
            ...
            <div class="form-grid">
              <div class="field">
                <label>Vorname *</label>
                <input [(ngModel)]="customer.vorname" name="customerVorname" required />
              </div>
              <div class="field">
              ...
              <div class="field">
                <label>Straße *</label>
                <input [(ngModel)]="customer.strasse" name="customerStrasse" required />
              </div>
              <div class="field">
                <label>Hausnummer *</label>
                <input [(ngModel)]="customer.hausnummer" name="customerHausnr" required />
              </div>
              <div class="field">
                <label>PLZ *</label>
              ...
              <div class="field">
                <label>Stadt *</label>
                <input [(ngModel)]="customer.stadt" name="customerStadt" required />
              </div>
              <div class="field">
                <label>Telefon *</label>
                <input [(ngModel)]="customer.telefon" name="customerTelefon" required />
              </div>
              <div class="field">
                <label>E-Mail</label>
                <input [(ngModel)]="customer.email" name="customerEmail" type="email" />
              </div>
              <div class="field">
          ...
          <div class="form-card">
            <div class="section-header">
              ...
              <div class="accessory-actions">
                ...
                <button type="button" class="btn btn-outline btn-sm" (click)="addCustomAccessory()">
                  Manuell eingeben
                </button>
              </div>
            </div>
          ...
          <div class="form-card">
            ...
            <div class="calendar-wrap">
              ...
              <div class="calendar" *ngIf="!busyPeriodsLoading">
                ...
                <div class="cal-grid">
                  ...
                  <div
                    *ngFor="let day of calendarDays"
                    ...
                    [class.picking-end]="pickingState === 'end' && day && !isDayBusy(day) && !isDayRangeStart(day)"
                    (click)="day && onCalendarDayClick(day)"
                  >
                    <span *ngIf="day">{{ day.getDate() }}</span>
                    <div class="busy-tooltip" *ngIf="day && isDayBusy(day)">Besetzt</div>
                  </div>
                </div>
                ...
                <div class="cal-legend">
                  ...
                  <span class="legend-item legend-hint" *ngIf="!selectedBike && !isQuickAddMode">
            ...
            <div class="price-calc" *ngIf="rentalDays > 0">
              <div class="calc-header">
                ...
                <span class="calc-price">Berechneter Preis: {{ berechneterPreis | number: '1.2-2' }} €</span>
              </div>
            ...
            <div class="form-grid" style="margin-top: 16px;">
              <div class="field">
                ...
                <input type="number" step="0.01" [(ngModel)]="gesamtmiete" name="gesamtmiete" required min="0" />
              </div>
              <div class="field">
                <label>Rabatt (€)</label>
                <input type="number" step="0.01" [(ngModel)]="rabatt" name="rabatt" min="0" (ngModelChange)="onRabattChanged()" />
              </div>
              <div class="field">
                <label>Kaution (€) *</label>
                <input type="number" step="0.01" [(ngModel)]="kaution" name="kaution" required min="0" />
              </div>
              <div class="field">
              ...
              <div class="field">
                ...
                <select [(ngModel)]="zustandBeiUebergabe" name="zustandBeiUebergabe" required>
        ...
        <div class="form-actions">
          ...
          <button
            ...
            [disabled]="submitting || (!selectedBike && !isQuickAddMode) || !f.form.valid || !startDatum || !endDatum"
          >
  ...
  styles: [`
    ...
    .booking-link { margin-left: auto; font-weight: 600; color: var(--accent-primary,#6366f1); text-decoration: none; }
    ...
    label { font-size: 0.82rem; font-weight: 600; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.03em; }
    ...
    .cal-title { font-size: 0.9rem; font-weight: 700; color: var(--text-primary); }
    .cal-nav-btn {
      display: flex;
      align-items: center;
    ...
    .cal-nav-btn:hover { background: var(--border-light); color: var(--text-primary); }
    .cal-grid {
      display: grid;
    ...
    .cal-day.range-start.in-range, .cal-day.range-end.in-range {
      border-radius: 8px;
    }
    ...
    .cal-day.busy:hover .busy-tooltip { display: block; }
    .cal-legend {
      display: flex;
      align-items: center;
      gap: 16px;
    ...
    .busy-dot { background: rgba(239,68,68,0.7); }
    .selected-dot { background: var(--accent-primary,#6366f1); }
    .legend-hint { color: var(--accent-warning,#f59e0b); font-style: italic; }
    .cal-hint {
      text-align: center;
      font-size: 0.78rem;
      color: var(--text-muted);
    ...
    .calc-breakdown { margin-top: 6px; font-size: 0.82rem; color: var(--text-secondary,#64748b); }
    ...
    .accessory-actions { display: flex; gap: 8px; align-items: center; flex-wrap: wrap; }
    .accessory-picker {
      padding: 8px 12px;
      border: 1.5px solid var(--border-color);
      border-radius: var(--radius-md,10px);
    ...
    .price-input input { border: none; border-radius: 0; padding: 8px 6px; flex: 1; min-width: 0; }
    .price-input input:focus { outline: none; box-shadow: none; }
    .unit { padding: 0 8px; font-size: 0.82rem; color: var(--text-muted); white-space: nowrap; }
    .qty-input {
      display: flex;
      align-items: center;
      border: 1.5px solid var(--border-color);
    ...
    .qty-input input { border: none; border-radius: 0; padding: 8px 4px; text-align: center; flex: 1; min-width: 0; }
    ...
    .btn-remove:hover { border-color: #ef4444; color: #ef4444; background: rgba(239,68,68,0.06); }
    .accessory-total-row {
      display: flex;
    ...
    .acc-total-sum { color: var(--accent-primary,#6366f1); font-size: 0.95rem; }
    ...
    .quick-add-form h3 { margin: 0 0 12px 0; font-size: 0.95rem; font-weight: 700; color: #10b981; }
    .bike-edit-form {
      margin-top: 16px; padding: 16px;
      background: var(--bg-secondary,#f8fafc);
      border-radius: var(--radius-md,10px);
    ...
    .bike-edit-form h3 { margin: 0 0 12px 0; font-size: 0.95rem; font-weight: 700; color: var(--accent-primary,#6366f1); }

    @media (max-width: 640px) {
      .form-grid { grid-template-columns: 1fr; }
      .accessory-header-row, .accessory-row { grid-template-columns: 1fr 90px 100px 70px 32px; }
      .date-display { flex-wrap: wrap; }
    }
  `],
})
export class RentalFormComponent implements OnInit {
  ...
  bikeEdit = { rahmennummer: '', marke: '', modell: '', farbe: '', reifengroesse: '', fahrradtyp: '' };

  customer: CustomerCreate = { vorname: '', nachname: '', strasse: '', hausnummer: '', plz: '', stadt: '', telefon: '', email: '' };
  ...
  get calendarMonthName(): string { return MONTH_NAMES[this.calendarMonth]; }
  ...
  isDayInRange(date: Date): boolean {
    ...
    const t = date.getTime();
    return t > new Date(this.startDatum).getTime() && t < new Date(this.endDatum).getTime();
  }
  ...
  onCalendarDayClick(date: Date) {
    ...
    if (overlaps) {
      this.notificationService.error('Dieser Zeitraum überschneidet sich mit einer bestehenden Buchung oder Vermietung.');
      return;
    }
  ...
  private loadBusyPeriods(bikeId: number) {
    ...
    this.bicycleService.getBusyPeriods(bikeId).subscribe({
      ...
      error: () => { this.busyPeriodsLoading = false; },
    });
  }
        ...
        if (bookingId) {
          ...
          this.bookingService.getById(this.fromBookingId).subscribe({
            next: (booking) => {
              ...
              const match = this.availableBikes.find((b) => b.id === booking.bicycle.id);
              if (match) {
  ...
  calculatePrice(days: number): number {
    if (days <= 1) { this.preisInfo = '1 Tag = 12,00 €'; return 12; }
    if (days <= 3) { this.preisInfo = '3 Tage-Paket = 30,00 €'; return 30; }
    if (days <= 7) { this.preisInfo = '7 Tage-Paket = 55,00 €'; return 55; }
    if (days <= 14) { this.preisInfo = '14 Tage-Paket = 95,00 €'; return 95; }
    if (days <= 30) { this.preisInfo = '30 Tage-Paket = 160,00 €'; return 160; }
    const extra = days - 30;
  ...
  submit() {
    ...
    if (this.isQuickAddMode) {
      ...
      this.bicycleService.update(this.selectedBike.id, bikeUpdate).subscribe({
        ...
        error: (err) => {
          this.submitting = false;
          this.notificationService.error(err.error?.error || 'Fehler beim Aktualisieren des Fahrrads');
        },
      });
    }
  }
  ...
  private createRental(bicycleId: number) {
    ...
    this.rentalService.create(rental).subscribe({
      ...
      error: (err) => {
        this.submitting = false;
        this.notificationService.error(err.error?.error || 'Fehler beim Anlegen der Vermietung');
      },
    });
  }
}
