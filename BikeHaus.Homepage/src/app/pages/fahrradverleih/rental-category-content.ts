...
export const RENTAL_CATEGORIES: RentalCategory[] = [
  {
    ...
    translations: {
      de: {
        ...
        heroBadges: ['🔋 80+ km Reichweite', '⚡ Bosch & Shimano', '🪖 Helm & Schloss inkl.'],
        ...
        features: [
          { title: 'Starke Mittelmotoren', text: 'Bosch Performance Line oder Shimano Steps – kraftvoll an Steigungen, leise auf der Straße.' },
          { title: 'Lange Reichweite', text: 'Akkus mit 500–625 Wh schaffen 60 bis 120 km je nach Gelände und Unterstützungsstufe.' },
          { title: 'Hochwertige Komponenten', text: 'Hydraulische Scheibenbremsen, präzise Schaltung und stabile Rahmen für jede Tour.' },
          { title: 'Volle Ausstattung', text: 'Licht, Schutzbleche, Gepäckträger und Ständer – alles dabei, was du brauchst.' },
        ],
        ...
        faq: [
          { q: 'Brauche ich einen Führerschein für ein Miet-E-Bike?', a: 'Nein. Unsere Pedelecs unterstützen bis 25 km/h und sind führerscheinfrei – ab 14 Jahren erlaubt, ein Helm wird empfohlen und ist bei uns inklusive.' },
      ...
      en: {
        ...
        heroBadges: ['🔋 80+ km range', '⚡ Bosch & Shimano', '🪖 Helmet & lock incl.'],
        ...
        features: [
          { title: 'Powerful mid-drives', text: 'Bosch Performance Line or Shimano Steps — strong on climbs, quiet on the road.' },
          { title: 'Long range', text: 'Batteries between 500 and 625 Wh deliver 60 to 120 km depending on terrain and assist level.' },
          { title: 'Premium components', text: 'Hydraulic disc brakes, precise shifting and stable frames built for every tour.' },
          { title: 'Fully equipped', text: 'Lights, mudguards, rear rack and kickstand — everything you need is included.' },
        ],
        ...
        faq: [
          { q: 'Do I need a licence to rent an e-bike?', a: 'No. Our pedelecs are speed-limited to 25 km/h and require no licence — allowed from age 14, a helmet is recommended and always included.' },
          { q: 'How far can I ride on a single charge?', a: 'Depending on the model, weight and assist level, between 60 and 120 km. For longer tours we recommend a spare battery or planning a charging stop.' },
          { q: 'How much does an e-bike cost per day?', a: 'Daily prices start at €15. From day 8 onwards you only pay €12 per day — ideal for longer stays.' },
          { q: 'What frame sizes do you have?', a: 'We offer S, M, L and XL frames for riders between approximately 155 and 195 cm. A test ride at the shop is always possible.' },
          { q: 'Can I pick up the e-bike on weekends?', a: 'Yes, Saturdays from 11:30 to 17:00. For Sunday/holiday pickups please arrange via WhatsApp in advance.' },
        ],
      ...
      fr: {
        ...
        heroBadges: ['🔋 80+ km d\'autonomie', '⚡ Bosch & Shimano', '🪖 Casque & antivol inclus'],
        ...
        features: [
          { title: 'Moteurs centraux puissants', text: 'Bosch Performance Line ou Shimano Steps — puissants en côte, silencieux sur la route.' },
          { title: 'Grande autonomie', text: 'Batteries de 500 à 625 Wh : 60 à 120 km selon le terrain et le niveau d\'assistance.' },
          { title: 'Composants haut de gamme', text: 'Freins à disque hydrauliques, transmission précise et cadres stables, conçus pour toutes les sorties.' },
          { title: 'Entièrement équipé', text: 'Éclairage, garde-boue, porte-bagages et béquille — tout y est.' },
        ],
        ...
        faq: [
          { q: 'Faut-il un permis pour louer un VAE ?', a: 'Non. Nos VAE sont bridés à 25 km/h et ne nécessitent pas de permis — autorisés dès 14 ans, casque recommandé et toujours inclus.' },
          { q: 'Quelle autonomie sur une charge ?', a: 'Selon le modèle, le poids et le niveau d\'assistance, entre 60 et 120 km. Pour les longues sorties, nous recommandons une batterie de rechange ou un arrêt de recharge prévu.' },
          { q: 'Combien coûte un VAE par jour ?', a: 'Les tarifs journaliers démarrent à 15 €. À partir du 8e jour, vous ne payez plus que 12 € par jour — idéal pour les longs séjours.' },
          { q: 'Quelles tailles de cadre proposez-vous ?', a: 'Nous proposons des cadres S, M, L et XL pour des personnes mesurant environ 155 à 195 cm. Un essai en magasin est toujours possible.' },
          { q: 'Puis-je récupérer le VAE le week-end ?', a: 'Oui, le samedi de 11h30 à 17h00. Pour les retraits le dimanche ou jours fériés, contactez-nous au préalable sur WhatsApp.' },
        ],
  ...
  },
  {
    ...
    translations: {
      de: {
        ...
        heroBadges: ['🎒 Gepäckträger inkl.', '💡 Licht & Reflektoren', '🪖 Helm & Schloss inkl.'],
        ...
        features: [
          { title: 'Aufrechte Sitzposition', text: 'Komfortabler Lenker und ergonomische Sättel – auch auf langen Strecken bequem.' },
          { title: 'Komplette Tourenausstattung', text: 'Gepäckträger, Schutzbleche, LED-Licht, Reflektoren und Ständer serienmäßig.' },
          { title: 'Robuste Komponenten', text: '24- oder 27-Gang-Schaltung, hydraulische oder mechanische Felgenbremsen, pannensichere Reifen.' },
          { title: 'Größen für alle', text: 'Damen- und Herrenrahmen in S, M, L und XL – auch Mixte-Modelle für leichteres Aufsteigen.' },
        ],
        ...
        faq: [
          { q: 'Eignet sich ein Trekkingrad für den Schwarzwald?', a: 'Ja, für moderate Anstiege und Schotterwege ideal. Für steile Berge wie den Schauinsland empfehlen wir eher ein E-Bike.' },
          { q: 'Kann ich Gepäck transportieren?', a: 'Alle unsere Trekkingräder haben einen stabilen Gepäckträger. Fahrradtaschen können wir auf Anfrage gegen Aufpreis mitvermieten.' },
          { q: 'Was kostet ein Trekkingrad pro Tag?', a: 'Die Preise beginnen bei 12 € pro Tag. Bei längerer Miete sinkt der Tagessatz, ab dem 8. Tag zahlst du nur 8 €.' },
          { q: 'Welche Rahmengrößen habt ihr?', a: 'Wir führen S (155–168 cm), M (168–178 cm), L (178–188 cm) und XL (188–195 cm) – sowohl Damen- als auch Herrenrahmen.' },
          { q: 'Kann ich mehrere Räder gleichzeitig mieten?', a: 'Ja, für Familien und Gruppen kein Problem. Schreib uns vorher per WhatsApp, damit wir Verfügbarkeit und passende Größen prüfen.' },
        ],
      ...
      en: {
        metaTitle: 'Rent a Trekking Bike in Freiburg | Touring Bike from €12/day',
        metaDescription:
        ...
        heroBadges: ['🎒 Rack included', '💡 Lights & reflectors', '🪖 Helmet & lock incl.'],
        ...
        features: [
          { title: 'Upright riding position', text: 'Comfortable handlebars and ergonomic saddles — comfortable even on long rides.' },
          { title: 'Full touring equipment', text: 'Rear rack, mudguards, LED lights, reflectors and kickstand as standard.' },
          { title: 'Robust components', text: '24 or 27-gear shifting, hydraulic or mechanical rim brakes, puncture-resistant tyres.' },
          { title: 'Sizes for everyone', text: 'Men\'s and women\'s frames in S, M, L and XL — also mixte models for easier mounting.' },
        ],
        ...
        faq: [
          { q: 'Is a trekking bike suitable for the Black Forest?', a: 'Yes, ideal for moderate climbs and gravel paths. For steep mountains like the Schauinsland we recommend an e-bike instead.' },
          { q: 'Can I carry luggage?', a: 'All our trekking bikes come with a sturdy rear rack. Panniers can be added on request for a small extra fee.' },
          { q: 'How much does a trekking bike cost per day?', a: 'Prices start from €12 per day. The daily rate drops with longer rentals — from day 8 onwards you pay only €8.' },
          { q: 'What frame sizes do you offer?', a: 'We stock S (155–168 cm), M (168–178 cm), L (178–188 cm) and XL (188–195 cm) — in both men\'s and women\'s frames.' },
          { q: 'Can I rent multiple bikes at once?', a: 'Yes, no problem for families and groups. Message us on WhatsApp first so we can confirm availability and matching sizes.' },
        ],
      ...
      fr: {
        metaTitle: 'Louer un vélo de trekking Fribourg | Vélo touring dès 12 €/jour',
        metaDescription:
        ...
        heroBadges: ['🎒 Porte-bagages inclus', '💡 Éclairage & réflecteurs', '🪖 Casque & antivol inclus'],
        ...
        features: [
          { title: 'Position de conduite droite', text: 'Cintre confortable et selle ergonomique — agréable même sur de longues distances.' },
          { title: 'Équipement de voyage complet', text: 'Porte-bagages, garde-boue, éclairage LED, réflecteurs et béquille de série.' },
          { title: 'Composants robustes', text: 'Transmission 24 ou 27 vitesses, freins hydrauliques ou mécaniques, pneus résistants aux crevaisons.' },
          { title: 'Tailles pour tous', text: 'Cadres homme et femme en S, M, L et XL — modèles mixte également pour un enjambement facile.' },
        ],
        ...
        faq: [
          { q: 'Un vélo de trekking convient-il à la Forêt-Noire ?', a: 'Oui, idéal pour les montées modérées et les chemins gravillonnés. Pour les montagnes raides comme le Schauinsland, nous recommandons plutôt un VAE.' },
          { q: 'Puis-je transporter des bagages ?', a: 'Tous nos vélos de trekking sont équipés d\'un porte-bagages robuste. Des sacoches peuvent être ajoutées sur demande moyennant un petit supplément.' },
          { q: 'Combien coûte un vélo de trekking par jour ?', a: 'Les tarifs démarrent à 12 € par jour. Plus la durée est longue, plus le tarif baisse — dès le 8e jour, seulement 8 €.' },
          { q: 'Quelles tailles de cadre proposez-vous ?', a: 'Nous proposons S (155–168 cm), M (168–178 cm), L (178–188 cm) et XL (188–195 cm) — cadres homme et femme.' },
          { q: 'Puis-je louer plusieurs vélos en même temps ?', a: 'Oui, sans souci pour les familles et les groupes. Écrivez-nous d\'abord sur WhatsApp pour confirmer la disponibilité et les tailles.' },
        ],
  ...
  },
  {
    ...
    translations: {
      de: {
        ...
        heroBadges: ['👶 16" bis 26"', '🪖 Kinderhelm inkl.', '👨‍👩‍👧 Familienrabatt'],
        ...
        features: [
          { title: 'Größen 16" bis 26"', text: 'Vom Anfängerrad bis zum Jugendrad – passend für Kinder ab ca. 4 Jahren bis Teenager.' },
          { title: 'Sicherheitsausstattung', text: 'Funktionierende Bremsen (Rücktritt oder V-Brake), helle Reflektoren, Klingel und Licht.' },
          { title: 'Kinderhelm inklusive', text: 'Helme in Größen XS bis M, anpassbar und mit Sicherheitsverschluss.' },
          { title: 'Robust und gepflegt', text: 'Jedes Rad wird vor jeder Vermietung komplett durchgecheckt.' },
        ],
        ...
        faq: [
          { q: 'Ab welchem Alter habt ihr Kinderräder?', a: 'Wir haben Räder ab 16" (ca. 4–6 Jahre, 100–115 cm Körpergröße) bis 26" Jugendräder. Komm gerne vorbei, wir messen dein Kind direkt aus.' },
          { q: 'Ist ein Kinderhelm inklusive?', a: 'Ja, immer. Wir haben Kinderhelme in den Größen XS bis M, alle mit weichem Innenfutter und Sicherheitsverschluss.' },
          { q: 'Habt ihr Stützräder oder Anhänger?', a: 'Stützräder können auf Wunsch montiert werden. Kinderanhänger und Trail-Gator (Anhänger-Stange) sind auf Anfrage gegen Aufpreis verfügbar.' },
          { q: 'Gibt es einen Familienrabatt?', a: 'Ja. Bei 2 oder mehr Rädern (Mix aus Erwachsenen und Kindern) gewähren wir je nach Mietdauer einen Rabatt – frag uns einfach vor der Reservierung.' },
          { q: 'Welche Routen eignen sich für Kinder rund um Freiburg?', a: 'Wir empfehlen den Dreisamradweg, die Strecke nach Kirchzarten oder den Mooswald. Alles flach und gut beschildert. Detaillierte Tipps geben wir gerne bei der Übergabe.' },
        ],
      ...
      en: {
        ...
        heroBadges: ['👶 16" to 26"', '🪖 Kids helmet incl.', '👨‍👩‍👧 Family discount'],
        ...
        features: [
          { title: 'Sizes 16" to 26"', text: 'From beginner bikes to junior bikes — fitting children from approx. age 4 to teenagers.' },
          { title: 'Safety equipment', text: 'Working brakes (coaster or V-brake), bright reflectors, bell and lights.' },
          { title: 'Kids helmet included', text: 'Helmets in sizes XS to M, adjustable and with safety closure.' },
          { title: 'Robust and well-maintained', text: 'Every bike is fully checked before each rental.' },
        ],
        ...
        faq: [
          { q: 'From what age do you have kids bikes?', a: 'We have bikes from 16" (around age 4–6, height 100–115 cm) up to 26" junior bikes. Drop by — we will measure your child for the right fit.' },
          { q: 'Is a kids helmet included?', a: 'Yes, always. We have children\'s helmets in sizes XS to M, all with soft padding and safety closure.' },
          { q: 'Do you have training wheels or trailers?', a: 'Training wheels can be fitted on request. Child trailers and trail-gator (tow bar) are available on request for a small extra fee.' },
          { q: 'Is there a family discount?', a: 'Yes. For 2 or more bikes (adult + kids combo) we offer a discount depending on rental duration — just ask before reserving.' },
          { q: 'Which routes are suitable for kids around Freiburg?', a: 'We recommend the Dreisam cycle path, the route to Kirchzarten or Mooswald. All flat and well-signposted. We are happy to share detailed tips at handover.' },
        ],
      ...
      fr: {
        metaTitle: 'Louer un vélo enfant Fribourg | Location famille dès 6 €/jour',
        metaDescription:
        ...
        heroBadges: ['👶 16" à 26"', '🪖 Casque enfant inclus', '👨‍👩‍👧 Tarif famille'],
        ...
        features: [
          { title: 'Tailles 16" à 26"', text: 'Du vélo débutant au vélo junior — adapté aux enfants d\'environ 4 ans aux adolescents.' },
          { title: 'Équipement de sécurité', text: 'Freins fonctionnels (rétropédalage ou V-brake), réflecteurs lumineux, sonnette et éclairage.' },
          { title: 'Casque enfant inclus', text: 'Casques en tailles XS à M, ajustables et avec fermeture de sécurité.' },
          { title: 'Robustes et entretenus', text: 'Chaque vélo est entièrement vérifié avant chaque location.' },
        ],
        ...
        faq: [
          { q: 'À partir de quel âge avez-vous des vélos enfants ?', a: 'Nous avons des vélos à partir de 16" (environ 4–6 ans, taille 100–115 cm) jusqu\'à des vélos juniors 26". Passez nous voir, nous mesurons votre enfant pour la bonne taille.' },
          { q: 'Un casque enfant est-il inclus ?', a: 'Oui, toujours. Nous avons des casques enfants en tailles XS à M, tous avec rembourrage doux et fermeture de sécurité.' },
          { q: 'Avez-vous des roulettes ou des remorques ?', a: 'Des roulettes peuvent être montées sur demande. Remorques enfant et trail-gator (barre de traction) disponibles sur demande contre un petit supplément.' },
          { q: 'Y a-t-il un tarif famille ?', a: 'Oui. Pour 2 vélos ou plus (combinaison adulte + enfant), nous appliquons une remise selon la durée — demandez-nous avant la réservation.' },
          { q: 'Quels itinéraires conviennent aux enfants autour de Fribourg ?', a: 'Nous recommandons la piste cyclable de la Dreisam, la route vers Kirchzarten ou le Mooswald. Tout est plat et bien balisé. Nous donnons des conseils détaillés à la remise.' },
        ],
