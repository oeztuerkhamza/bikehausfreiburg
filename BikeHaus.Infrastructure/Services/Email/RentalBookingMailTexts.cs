...
internal static class RentalBookingMailTexts
{
    ...
    private static Dictionary<string, string> De() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nHinweis: Der Verleih hat eigene Übergabezeiten, unabhängig von den Öffnungszeiten des Ladens (An- & Verkauf): Mo–Fr ab 10:00 Uhr, Sa ab 11:00 Uhr, sonntags geschlossen. Freitags ist von 13:00 bis 15:00 Uhr Mittagspause – in dieser Zeit finden keine Verleih-Übergaben statt.",
    ...
    private static Dictionary<string, string> En() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nNote: rentals have their own handover hours, independent of the shop's opening hours (sales): Mon–Fri from 10:00, Sat from 11:00, closed on Sundays. On Fridays there is a lunch break from 13:00 to 15:00 – no rental handovers during that time.",
    ...
    private static Dictionary<string, string> Fr() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nRemarque : la location a ses propres horaires de remise, indépendants des horaires d'ouverture du magasin (vente) : du lundi au vendredi dès 10h00, le samedi dès 11h00, fermé le dimanche. Le vendredi, pause déjeuner de 13h00 à 15h00 – aucune remise de vélo pendant ce créneau.",
    ...
    private static Dictionary<string, string> Tr() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nNot: Kiralamanın kendi teslim saatleri vardır, mağazanın (alış-satış) açılış saatlerinden bağımsızdır: Pzt–Cum 10:00'dan, Cmt 11:00'dan itibaren, pazar kapalı. Cuma günleri 13:00–15:00 arası öğle molasıdır – bu saatlerde kiralama teslimi yapılmaz.",
    ...
    private static Dictionary<string, string> Es() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nNota: el alquiler tiene sus propios horarios de entrega, independientes del horario de apertura de la tienda (venta): de lunes a viernes a partir de las 10:00, sábados a partir de las 11:00, domingos cerrado. Los viernes hay pausa para comer de 13:00 a 15:00: no se realizan entregas de alquiler.",
    ...
    private static Dictionary<string, string> It() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nNota: il noleggio ha orari di consegna propri, indipendenti dagli orari di apertura del negozio (vendita): da lunedì a venerdì dalle 10:00, il sabato dalle 11:00, domenica chiuso. Il venerdì c'è la pausa pranzo dalle 13:00 alle 15:00: in quella fascia non si effettuano consegne.",
    ...
    private static Dictionary<string, string> Ar() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nملاحظة: للتأجير أوقات تسليم خاصة به، مستقلة عن ساعات عمل المتجر (البيع): من الإثنين إلى الجمعة من الساعة 10:00، والسبت من الساعة 11:00، والأحد مغلق. يوم الجمعة استراحة غداء من 13:00 إلى 15:00 – لا يتم تسليم الدراجات خلال هذه الفترة.",
    ...
    private static Dictionary<string, string> Ru() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nПримечание: у проката свои часы выдачи, независимо от часов работы магазина (продажа): пн–пт с 10:00, сб с 11:00, воскресенье закрыто. По пятницам с 13:00 до 15:00 обеденный перерыв — выдача велосипедов в это время не производится.",
    ...
    private static Dictionary<string, string> No() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nMerk: utleien har egne utleveringstider, uavhengig av butikkens åpningstider (salg): man–fre fra kl. 10.00, lør fra kl. 11.00, søndag stengt. På fredager er det lunsjpause fra kl. 13.00 til 15.00 – ingen utlevering i dette tidsrommet.",
    ...
    private static Dictionary<string, string> Da() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nBemærk: udlejningen har sine egne udleveringstider, uafhængigt af butikkens åbningstider (salg): man–fre fra kl. 10.00, lør fra kl. 11.00, søndag lukket. Om fredagen er der frokostpause fra kl. 13.00 til 15.00 – der sker ingen udlevering i det tidsrum.",
    ...
    private static Dictionary<string, string> Nl() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nLet op: de verhuur heeft eigen overdrachtstijden, los van de openingstijden van de winkel (verkoop): ma–vr vanaf 10:00 uur, za vanaf 11:00 uur, zondag gesloten. Op vrijdag is er van 13:00 tot 15:00 uur lunchpauze – dan vinden geen overdrachten plaats.",
    ...
    private static Dictionary<string, string> Pl() => new()
    {
        ...
        [Keys.LineRentalHoursNote] = "\nUwaga: wypożyczalnia ma własne godziny wydawania, niezależne od godzin otwarcia sklepu (sprzedaż): pon–pt od 10:00, sob od 11:00, w niedziele nieczynne. W piątki od 13:00 do 15:00 jest przerwa obiadowa – w tym czasie nie wydajemy rowerów.",
